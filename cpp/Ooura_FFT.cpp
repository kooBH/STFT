...
Ooura_FFT::Ooura_FFT(int _frame_size, int _channels){
...
void Ooura_FFT::FFT(double **data) {
    int j;
...
void Ooura_FFT::iFFT(double **data) {
    int j;
...
void Ooura_FFT::SingleFFT(double *data) {
    int i;
...
void Ooura_FFT::SingleiFFT(double *data) {
    int i;
    ip[0][0] = 0;
    for (i = 0; i < frame_size; i += 2) {
        a[0][i] = data[i];
